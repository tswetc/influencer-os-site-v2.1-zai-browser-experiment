...
11. `03-REFERENCES/design-set-b/REFERENCE-RECIPE.md`
12. `04-MEDIA/transport/wave01-B-v2/manifest.json`
...
`04-MEDIA/transport/wave01-B-v2/`
...
Use the exact design-set-b reference recipe.
...
Export exactly:
`ZAI-E007-QUIET-PHOTOGRAPHIC-CINEMA-FINAL.zip`
