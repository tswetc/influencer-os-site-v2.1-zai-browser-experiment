...
11. `03-REFERENCES/design-set-a/REFERENCE-RECIPE.md`
12. `04-MEDIA/transport/wave01-A-v2/manifest.json`
...
Use the exact design-set-a reference recipe.
...
Export exactly:
`ZAI-E004-CONTROLLED-GRAPHIC-EDITORIAL-FINAL.zip`
