...
MEDIA_SET: wave01-D-v2
INPUT_COMMIT: TO_BE_PINNED_AT_LAUNCH
...
11. `03-REFERENCES/design-set-d/REFERENCE-RECIPE.md`
12. `04-MEDIA/transport/wave01-D-v2/manifest.json`
...
`04-MEDIA/transport/wave01-D-v2/`
...
Use the exact design-set-d reference recipe.
...
Export exactly:
`ZAI-E011-CONTINUOUS-SPATIAL-SYSTEM-FINAL.zip`
