# ZAI-P002 — Full-System Integration Pilot
...
10. `03-REFERENCES/design-set-a/REFERENCE-RECIPE.md`
...
Research the exact three design-set-a anchors.
...
Export:
`ZAI-P002-GLM53Flash-CONTROLLED-GRAPHIC-EDITORIAL-PILOT-FINAL.zip`
